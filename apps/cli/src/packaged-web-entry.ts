...
/**
 * Whether the packaged entry may `chdir` to the executable directory.
 * CLI heads keep the invoking cwd so relative plugin and `--patch` specs
 * resolve against the caller's directory. Script and eval never reach this.
