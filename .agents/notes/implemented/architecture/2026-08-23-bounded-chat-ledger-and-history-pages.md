...
- Page weight still is not byte-bounded — one exchange with a huge tool result can dominate a page ([large-provenance scan note](../../archived/bug-fix/2026-08-04-large-history-pagination-call-stack.md)); the two concerns remain separate.
