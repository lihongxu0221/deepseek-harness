...
The [pre-release stance](../../../../AGENTS.md#pre-release-stance-foundation-over-blast-radius) still rejects old on-disk and wire formats. It does not authorize renaming or deleting `master` source files or identifiers.
