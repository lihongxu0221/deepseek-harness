...
import {
  ...
  workspaceSetPrimaryFolderRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'workspace.setPrimaryFolder': { schema: workspaceSetPrimaryFolderRequestSchema, invoke: (api, r) => api.workspace.setPrimaryFolder(r) },
