...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('workspace-folder-primary'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('workspace-folder-unknown'), message: z.string(), details: z.object({ path: z.string() }) }),
