...
describe('WorkspaceController', () => {
  ...
  it('maps generated business failures to the command facade errors', async ({ mock, start }) => {
    ...
    mock.remote.workspace.addFolder.mockResolvedValueOnce(err(new RemoteError('workspace/invalid-path', 'missing folder', { path: '/gone' })))
    ...
    mock.remote.workspace.removeFolder.mockResolvedValueOnce(err(new RemoteError('workspace/folder-primary', 'primary', { path: '/work/one' })))
    ...
    mock.remote.workspace.setPrimaryFolder.mockResolvedValueOnce(err(new RemoteError('workspace/folder-unknown', 'unknown', { path: '/gone' })))
