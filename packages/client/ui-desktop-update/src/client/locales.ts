...
export const zh = {
  ...
  'downloading': '正在下载',
  'apply': '重启并更新',
  'applying': '正在替换程序文件并重启',
  'ready': '已下载，退出后替换程序文件并重启',
  'upToDate': '已是最新打包',
  'outdated': '发现新的打包',
...
export const en = {
  ...
  'apply': 'Restart and update',
  'applying': 'Replacing program files and restarting',
  'ready': 'Downloaded. Quit to replace program files and restart.',
