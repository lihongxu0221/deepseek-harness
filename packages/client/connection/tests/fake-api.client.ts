...
export class FakeApiClient implements IApiClient {
  ...
  readonly workspace: IApiClient['workspace'] = {
    ...
    setPrimaryFolder: (payload: unknown) => this.record('workspace.setPrimaryFolder', payload, Promise.resolve(ok({
      workspace: { workspaceId: 'fk-ws' as never, path: (payload as { path: string }).path, folders: ['/f/ws'], title: 'ws', sessionIds: [], createdAt: '0', updatedAt: '0' },
    }))),
