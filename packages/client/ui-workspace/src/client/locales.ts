...
export const zh = {
  ...
  'section.sessions': '会话',
  'section.recents': '最近会话',
  'section.workspaces.toggle': '折叠或展开工作区',
  'section.recents.toggle': '折叠或展开最近会话',
  'empty.workspaces': '暂无工作区',
  'empty.recents': '暂无最近会话',
  ...
  'menu.editProject': '编辑项目',
  'edit.project.title': '编辑项目',
  'edit.project.sources': '源文件夹',
  'edit.project.primary': '主要',
  'edit.project.setPrimary': '设为主要',
  'edit.project.addFolder': '添加文件夹',
  'edit.project.removeFolder.aria': '移除文件夹“{name}”',
  'hover.pin': '置顶',
  'hover.unpin': '取消置顶',
  'hover.sessions.one': '{n} 个任务',
  'hover.sessions.other': '{n} 个任务',
  'edit.project.remove': '移除本地项目',
  'edit.project.saving': '正在保存…',
...
export const en = {
  ...
  'section.workspaces.toggle': 'Collapse or expand workspaces',
  'section.recents.toggle': 'Collapse or expand recents',
  'empty.workspaces': 'No workspaces yet',
  'empty.recents': 'No recent sessions',
  ...
  'edit.project.sources': 'Source folders',
  'edit.project.primary': 'Primary',
  'edit.project.setPrimary': 'Set as primary',
  'edit.project.addFolder': 'Add folder',
  'edit.project.removeFolder.aria': 'Remove folder {name}',
  'hover.pin': 'Pin',
  'hover.unpin': 'Unpin',
  'hover.sessions.one': '{n} task',
  'hover.sessions.other': '{n} tasks',
  'edit.project.remove': 'Remove local project',
  'edit.project.saving': 'Saving…',
