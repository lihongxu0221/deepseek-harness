 ...
 * title is scrolled programmatically while the row is hovered. The workspace
 * row menu keeps Edit project, Remove folder, Rename, and Delete; session
 * Rename/Fork/Archive stay on the row. Hover cards are suppressed while a menu
 * is open.
 */
